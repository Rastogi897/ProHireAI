  ...
  return (
    <div className="pt-14 z-50 relative">
      <div className="flex justify-center">
        <h3
          className="text-zinc-300 z-50 mx-auto text-lg font-normal mb-16 px-6 py-2 rounded-3xl shadow-md bg-gradient-to-b from-zinc-800 to-zinc-700"
      ...
      <h1 className="z-50 flex justify-center text-9xl font-medium font-display tracking-tight text-slate-900 sm:text-8xl">
        <span className="inline-block pr-4">
          <span className="bg-gradient-to-b from-zinc-500 to-zinc-200 bg-clip-text text-transparent">
            Your
          </span>
          <span className="relative whitespace-nowrap text-blue-600 pl-4">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-20 left-0 h-[0.58em] w-full fill-zinc-500 opacity-40"
            ...
            <span className="relative bg-gradient-to-b from-blue-600 to-blue-500 bg-clip-text text-transparent">
              AI Hiring
            </span>
          </span>
        </span>
        <span className="inline-block bg-gradient-to-b from-zinc-500 to-zinc-200 bg-clip-text text-transparent">
          Partner
        </span>
      </h1>
      ...
      <div className="z-50 flex flex-col items-center justify-center gap-5 mt-24 mb-12 md:flex-row">
        <div
          className="z-50 inline-block w-auto text-center min-w-[200px] px-6 py-4 text-zinc-200 shadow-xl rounded-md sm:w-auto bg-gradient-to-r from-blue-700 to-blue-600 cursor-pointer hover:shadow-2xl hover:shadow-blue-800"
        ...
        <div
          className="z-50 inline-block w-auto text-center min-w-[200px] px-6 py-4 text-zinc-200 shadow-lg transition-all bg-gradient-to-r from-zinc-800 to-zinc-700 rounded-md sm:w-auto cursor-pointer hover:shadow-2xl hover:shadow-zinc-700"
